      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="flex-grow basis-0 border border-gray-300 bg-blue-100 p-8 rounded-xl">
          <div className="space-y-6">
            <div className="my-4">
              <p className="bg-white font-semibold rounded-full p-1 w-32">Chat with us</p>
            ...
            <div className="my-4">
              <p className="bg-white font-semibold rounded-full p-1 w-28">Call us</p>
              <h3 className="text-gray-800 my-6 text-2xl">+952 4983 2098 2098</h3>
              <p className="text-sm text-gray-600">Chat with our team member</p>
            </div>
            <div className="my-4">
              <p className="bg-white font-semibold rounded-full p-1 w-28">Visit us</p>
